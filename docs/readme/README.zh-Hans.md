...
> 当前版本：**v1.5.33 (Build 58)**。可从 [GitHub Releases](https://github.com/hzagaming/ClassGod/releases/latest) 下载 DMG 或 PKG。
...
英语是开发语言，也是缺少翻译时的回退语言。App 字符串目录包含英语、简体中文、繁体中文、日语、韩语、法语、德语、西班牙语、葡萄牙语和俄语。
