...
> Version du code source : **v1.5.55 (Build 80)**. Les téléchargements publiés sont disponibles sur [GitHub Releases](https://github.com/hzagaming/ClassGod/releases/latest).
