...
> Version du code source : **v1.5.60 (Build 85)**. Les téléchargements publiés sont disponibles sur [GitHub Releases](https://github.com/hzagaming/ClassGod/releases/latest).
