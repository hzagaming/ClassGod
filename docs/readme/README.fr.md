...
> Version du code source : **v1.5.59 (Build 84)**. Les téléchargements publiés sont disponibles sur [GitHub Releases](https://github.com/hzagaming/ClassGod/releases/latest).
