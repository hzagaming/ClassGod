...
> Version du code source : **v1.5.56 (Build 81)**. Les téléchargements publiés sont disponibles sur [GitHub Releases](https://github.com/hzagaming/ClassGod/releases/latest).
