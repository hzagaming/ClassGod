...
2. **突然弹出将近 30 个小窗口**密集覆盖整个屏幕——终端乱码、系统错误警告、崩溃报告、矩阵字符雨，模拟一场系统崩溃的混乱
3. **弹窗逐个关闭**，像故障被逐个修复
...
### 修复 & 优化
- [x] 弹窗数量增加到 28-36，尺寸更大，覆盖更密集
- [x] 主窗口在动画开始前就创建在底层，等弹窗全部关闭后才显现
- [x] 动画性能优化：降低终端乱码和矩阵雨的刷新频率，避免卡顿
- [x] 修复全局呼出快捷键注册/录制问题
